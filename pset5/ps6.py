...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        for char in self.message_text:
            shiftedText += shiftedDict.get(char, char)
...
class PlaintextMessage(Message):
    ...
    def change_shift(self, shift):
        ...
        if 0 <= shift <26:
            ...
            raise ValueError('Shift must be inclusively between 0 and 25')
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for n in range(26):
            decrypted_message = self.apply_shift(n)
            ...
            if num_valid_words > bestCount:
                best = (n, decrypted_message)
                bestCount = num_valid_words
